...
if __name__ == "__main__":
    input_path = "data/Early_late_dataset/output/Prerequisite_predictions_early_1.xlsx"
    output_path = "data/Early_late_dataset/output/Prerequisite_predictions_early_score.xlsx"
