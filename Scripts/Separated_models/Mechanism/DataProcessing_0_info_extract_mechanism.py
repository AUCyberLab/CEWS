...
# ================= 1. File Paths =================
DATASET1_PATH = "data/Mechanism/CAPEC_parsed_with_level_and_mechanism.xlsx"
DATASET2_PATH = "data/Mechanism/CVE_CWE_withpageinfo_all.csv"
DATASET3_PATH = "data/GT/656_cve_capec_mappings.xlsx"
OUTPUT_PATH = "data/Mechanism/Mechanism_merged_large.xlsx"
...
merged_df = pd.merge(
    merged_df,
    df_capec[['CAPEC-ID', 'CAPEC_Name', 'CAPEC_Description', 'CAPEC_Mechanism']],
    on='CAPEC-ID',
    how='left'
)
