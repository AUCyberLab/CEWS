...
# ================= Configuration =================
parser = argparse.ArgumentParser(description="Run inference for CVE-CAPEC Mechanism Prediction.")
...
def run_prediction():
    ...
    for i in tqdm(range(0, total_records, BATCH_SIZE)):
        ...
        for row in batch_records:
            ...
            mechanism = row.get('CAPEC_Mechanism', '')

            input_text = (
                f"Target CAPEC:\n"
                f"CAPEC-ID: {capec_id}\n"
                f"CAPEC Name: {capec_name}\n"
                f"Target CAPEC Mechanism: {mechanism}\n\n"
