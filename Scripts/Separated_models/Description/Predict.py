...
# ================= Configuration =================
parser = argparse.ArgumentParser(description="Run inference for CVE-CAPEC Description Prediction.")
...
def run_prediction():
    ...
    for i in tqdm(range(0, total_records, BATCH_SIZE)):
        ...
        for row in batch_records:
            ...
            capec_description = row.get('CAPEC_Description', '')

            input_text = (
                f"Target CAPEC:\n"
                f"CAPEC-ID: {capec_id}\n"
                f"CAPEC Name: {capec_name}\n"
                f"Target CAPEC Description: {capec_description}\n\n"
