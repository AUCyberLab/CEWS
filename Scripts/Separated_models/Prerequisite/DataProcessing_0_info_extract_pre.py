...
# ================= 1. File Paths =================
DATASET1_PATH = "data/Prerequisite/capec_database_cleaned.xlsx"
DATASET2_PATH = "data/Mechanism/CVE_CWE_withpageinfo_all.csv"
DATASET3_PATH = "data/GT/656_cve_capec_mappings.xlsx"
OUTPUT_PATH = "data/Prerequisite/Prerequisite_marged_large.xlsx"
...
df_capec = df_capec.rename(columns={
    ...
    'Prerequisites': 'CAPEC_Prerequisites',
})
...
merged_df = pd.merge(
    merged_df,
    df_capec[['CAPEC-ID', 'CAPEC_Name', 'CAPEC_Description', 'CAPEC_Prerequisites']],
    on='CAPEC-ID',
    how='left'
)
